...
BLOCKED_STATIC_CONTRACTS=(
  "tests/contract/call-access-strong-mismatch-privacy-contract.mjs|current integration branch lacks the worker-owned Playwright case: strong personalized-link mismatch wrong host denial gives no access and leaks no foreign person data"
)
