...
STATIC_CONTRACTS=(
  ...
  "tests/contract/call-access-link-invalidation-durability-contract.mjs"
  "tests/contract/call-access-parallel-account-tabs-contract.mjs"
  "tests/contract/call-access-cross-org-foreign-join-contract.mjs"
  "tests/contract/iam-cross-org-remaining-proof-contract.mjs"
...
SQLITE_BACKEND_CONTRACTS=(
  ...
  "tests/call-access-registered-logged-out-invitee-contract.sh"
  "tests/call-access-registered-logged-in-invitee-contract.sh"
  "tests/call-access-security-manipulation-contract.sh"
  "tests/call-access-anonymous-disabled-link-contract.sh"
  "tests/call-access-anonymous-temp-rights-contract.sh"
  ...
  "tests/call-access-anonymous-logged-in-rights-contract.sh"
  ...
  "tests/call-access-membership-stale-invite-rights-contract.sh"
  "tests/call-access-stale-organization-role-contract.sh"
  "tests/audit-call-access-events-contract.sh"
  "tests/call-access-authorized-rejoin-contract.sh"
