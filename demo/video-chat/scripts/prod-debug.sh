...
filter_recent_logs "background fallback transitions" 'local_background_(backend_init|matte_rejected|replacement_unavailable|replacement_modal_choice)|background_(backend_init_failed|matte_rejected|modal_choice|replacement_requires_user_choice)|production_category_mask_unavailable|worker_segment_errors_repeated|segmentation_backend_init_failed|segmentation_unavailable|failed_backend|fallback_reason|user_choice_required'
