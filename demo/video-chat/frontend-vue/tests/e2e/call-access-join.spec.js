...
test('same personalized link in parallel contexts keeps account sessions isolated', async ({ browser }) => {
  ...
  const requests = {
    a: { sessionStateAuthorization: '', sessionAuthorization: '', sessionBody: null, joinGetCount: 0, sessionPostCount: 0 },
    b: { sessionStateAuthorization: '', sessionAuthorization: '', sessionBody: null, joinGetCount: 0, sessionPostCount: 0 },
  };
