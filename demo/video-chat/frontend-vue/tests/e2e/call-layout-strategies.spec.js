...
async function withCallLayoutHelpers(page, callbackSource) {
  await page.goto('/src/domain/realtime/layout/strategies.ts', { waitUntil: 'domcontentloaded' });
  return page.evaluate(async (source) => {
    const helpers = await import('/src/domain/realtime/layout/strategies.ts');
