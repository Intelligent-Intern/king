...
assert.match(workspaceShell, /settingsDraft\.language = normalizeSettingsLanguage\(sessionState\.locale \|\| readStoredSettingsLanguage\(\)\)/, 'settings draft must prefer backend locale');
