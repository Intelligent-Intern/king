...
try {
  ...
  requireContains(gateway, 'videochat_sfu_live_frame_relay_publish($roomStateKey, (string) $clientId, $relayFrame)', 'live relay publishes the JSON-safe frame under the tenant-scoped room key');
