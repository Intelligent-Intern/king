...
assert.match(modalSource, /AppSidePanelShell/, 'governance CRUD form must use the shared right side panel shell');
assert.doesNotMatch(modalSource, /\bmaximizable\b/, 'governance CRUD side panel must not expose maximize or resize controls');
