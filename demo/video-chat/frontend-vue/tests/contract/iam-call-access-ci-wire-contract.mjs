...
const requiredIamContractPaths = [
  ...
  'frontend-vue/tests/contract/call-access-link-invalidation-active-state-contract.mjs',
  ...
  'frontend-vue/tests/contract/iam-call-access-audit-events-contract.mjs',
  'frontend-vue/tests/contract/call-access-email-safe-texts-dispatch-audit-contract.mjs',
  ...
  'frontend-vue/tests/contract/call-access-cross-org-foreign-join-contract.mjs',
  'frontend-vue/tests/contract/call-access-edge-error-matrix-contract.mjs',
  'frontend-vue/tests/contract/iam9-12-deleted-ended-hardening-contract.mjs',
  ...
  'frontend-vue/tests/contract/iam-org-removal-active-privilege-downgrade-contract.mjs',
  'frontend-vue/tests/contract/iam-owner-absence-realtime-sync-contract.mjs',
  ...
  'frontend-vue/tests/contract/call-access-authorized-rejoin-extract-contract.mjs',
...
const requiredIamSupportingPaths = [
  ...
  'backend-king-php/tests/call-access-privacy-contract.php',
  'backend-king-php/tests/call-access-privacy-contract.sh',
  'backend-king-php/tests/call-access-session-fixation-contract.php',
  'backend-king-php/tests/call-access-session-fixation-contract.sh',
  'backend-king-php/tests/call-access-decision-contract.php',
  'backend-king-php/tests/call-access-decision-contract.sh',
  'backend-king-php/tests/call-access-authorized-rejoin-contract.sh',
  'backend-king-php/tests/call-access-deleted-ended-disabled-join-contract.sh',
  'backend-king-php/tests/call-access-strong-mismatch-privacy-contract.sh',
  'backend-king-php/tests/call-lifecycle-contract.sh',
  'backend-king-php/tests/iam11-17-call-access-edge-proof-contract.sh',
  'backend-king-php/tests/call-owner-transfer-lifecycle-contract.sh',
  'backend-king-php/tests/system-admin-call-rights-contract.php',
  'backend-king-php/tests/system-admin-call-rights-contract.sh',
  'backend-king-php/tests/org-admin-call-rights-contract.php',
  'backend-king-php/tests/org-admin-call-rights-contract.sh',
  'backend-king-php/tests/call-owner-transfer-contract.php',
  'backend-king-php/tests/call-owner-transfer-contract.sh',
  'backend-king-php/tests/audit-call-access-events-contract.php',
  'backend-king-php/tests/audit-call-access-events-contract.sh',
  'backend-king-php/tests/audit-call-access-membership-contract.php',
  'backend-king-php/tests/audit-call-access-membership-contract.sh',
  ...
  'backend-king-php/tests/call-access-org-removal-active-privilege-downgrade-contract.sh',
