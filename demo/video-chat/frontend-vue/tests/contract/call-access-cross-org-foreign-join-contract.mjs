...
assert.match(
  backendContract,
  /foreign verified context should conflict[\s\S]*foreign verified context response[\s\S]*foreign verified context denial must not persist a call access session/,
