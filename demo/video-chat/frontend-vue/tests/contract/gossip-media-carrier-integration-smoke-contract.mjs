...
assert(
  !packageJson.includes('gossip-media-carrier-integration-smoke-contract.mjs')
    ...
    && packageJson.includes('gsp01-18-gossip-primary-plan-frame-contract.mjs')
  ...
  'active Gossip contract suite must replace the legacy integration smoke with current GSP01 topology/no-SFU proofs',
)
assert(
