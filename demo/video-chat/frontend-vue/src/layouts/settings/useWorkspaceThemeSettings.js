...
const THEME_COLOR_FIELDS = Object.freeze([
  { key: '--bg-shell', labelKey: 'theme_settings.color.shell_background', default: '#101b33' },
  { key: '--bg-pane', labelKey: 'theme_settings.color.pane_background', default: '#101b33' },
  { key: '--brand-bg', labelKey: 'theme_settings.color.brand_strip', default: '#1482be' },
  ...
  { key: '--line', labelKey: 'theme_settings.color.line', default: '#1d315c' },
  ...
  { key: '--bg-sidebar', labelKey: 'theme_settings.color.sidebar', default: '#1482be' },
  { key: '--bg-main', labelKey: 'theme_settings.color.main', default: '#101b33' },
  ...
  { key: '--border-subtle', labelKey: 'theme_settings.color.border_subtle', default: '#1d315c' },
