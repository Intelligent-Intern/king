...
const THEME_COLOR_FIELDS = Object.freeze([
  { key: '--bg-shell', labelKey: 'theme_settings.color.shell_background', default: '#09111e' },
  { key: '--bg-pane', labelKey: 'theme_settings.color.pane_background', default: '#182c4d' },
  { key: '--brand-bg', labelKey: 'theme_settings.color.brand_strip', default: '#09111e' },
  { key: '--bg-surface', labelKey: 'theme_settings.color.surface', default: '#003c93' },
  { key: '--bg-surface-strong', labelKey: 'theme_settings.color.surface_strong', default: '#0c1c33' },
  { key: '--bg-input', labelKey: 'theme_settings.color.input_background', default: '#d8dadd' },
  { key: '--bg-action', labelKey: 'theme_settings.color.action', default: '#0b1324' },
  { key: '--bg-action-hover', labelKey: 'theme_settings.color.action_hover', default: '#5696ef' },
  { key: '--bg-row', labelKey: 'theme_settings.color.row', default: '#2a569f' },
  { key: '--bg-row-hover', labelKey: 'theme_settings.color.row_hover', default: '#163260' },
  { key: '--line', labelKey: 'theme_settings.color.line', default: '#09111e' },
  { key: '--text-main', labelKey: 'theme_settings.color.text_main', default: '#edf3ff' },
  { key: '--text-muted', labelKey: 'theme_settings.color.text_muted', default: '#8490a1' },
  { key: '--ok', labelKey: 'theme_settings.color.ok', default: '#177f22' },
  { key: '--wait', labelKey: 'theme_settings.color.wait', default: '#8d9500' },
  { key: '--danger', labelKey: 'theme_settings.color.danger', default: '#ff0000' },
  { key: '--bg-sidebar', labelKey: 'theme_settings.color.sidebar', default: '#09111e' },
  { key: '--bg-main', labelKey: 'theme_settings.color.main', default: '#182c4d' },
  { key: '--bg-tab', labelKey: 'theme_settings.color.tab', default: '#003c93' },
  { key: '--bg-tab-hover', labelKey: 'theme_settings.color.tab_hover', default: '#5696ef' },
  { key: '--bg-tab-active', labelKey: 'theme_settings.color.tab_active', default: '#2a569f' },
  { key: '--bg-ui-chrome', labelKey: 'theme_settings.color.ui_chrome', default: '#3d5f98' },
  { key: '--bg-ui-chrome-active', labelKey: 'theme_settings.color.ui_chrome_active', default: '#2a569f' },
  { key: '--bg-icon', labelKey: 'theme_settings.color.icon_background', default: '#162e51' },
  { key: '--bg-icon-active', labelKey: 'theme_settings.color.icon_active', default: '#5696ef' },
  { key: '--border-subtle', labelKey: 'theme_settings.color.border_subtle', default: '#09111e' },
  { key: '--text-primary', labelKey: 'theme_settings.color.text_primary', default: '#edf3ff' },
  { key: '--text-secondary', labelKey: 'theme_settings.color.text_secondary', default: '#c6d4eb' },
  { key: '--text-dim', labelKey: 'theme_settings.color.text_dim', default: '#5e6d86' },
  { key: '--warn', labelKey: 'theme_settings.color.warn', default: '#4d5011' },
  { key: '--brand-cyan', labelKey: 'theme_settings.color.brand_cyan', default: '#1482be' },
  { key: '--brand-cyan-hover', labelKey: 'theme_settings.color.brand_cyan_hover', default: '#1a96d8' },
  { key: '--brand-cyan-active', labelKey: 'theme_settings.color.brand_cyan_active', default: '#0f6ea8' },
]);
