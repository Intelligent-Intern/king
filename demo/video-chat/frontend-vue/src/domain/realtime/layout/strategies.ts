...
export interface CallActivityEntry {
  topkScore2s?: number | string;
  topk_score_2s?: number | string;
  topkScore5s?: number | string;
  topk_score_5s?: number | string;
  topkScore15s?: number | string;
  topk_score_15s?: number | string;
  score2s?: number | string;
  score_2s?: number | string;
  score5s?: number | string;
  score_5s?: number | string;
  score15s?: number | string;
  score_15s?: number | string;
  score?: number | string;
...
export function rollingActivityScore(entry: CallActivityEntry | null | undefined): number {
  if (!entry || typeof entry !== 'object') return 0;
