...
export const SFU_VIDEO_QUALITY_PROFILES = Object.freeze({
  ...
  realtime: Object.freeze({
    ...
    readbackFrameRate: readbackFrameRateForInterval(125),
    readbackIntervalMs: 125,
  ...
  balanced: Object.freeze({
    ...
    readbackFrameRate: readbackFrameRateForInterval(100),
  ...
  quality: Object.freeze({
    ...
    encodeIntervalMs: 83,
    readbackFrameRate: readbackFrameRateForInterval(83),
    readbackIntervalMs: 83,
