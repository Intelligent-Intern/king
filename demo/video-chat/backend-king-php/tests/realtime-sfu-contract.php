...
try {
    ...
    videochat_realtime_sfu_assert(
        ...
        && str_contains($gossipMediaRelaySource, "\$targetCallId !== '' && \$targetCallId !== \$normalizedCallId"),
        'Room-bound Gossip media relay must bypass SFU publisher discovery through the existing call socket while remaining scoped to the call room'
    );
    videochat_realtime_sfu_assert(
