...
SQL
    ...
    videochat_call_access_session_assert((string) ($openPendingResolution['initial_room_id'] ?? '') === videochat_realtime_waiting_room_id(), 'open guest should wait in the lobby before FFA admission');
