                ...
                return $jsonResponse(200, [
                    ...
                    'user' => [
                        ...
                        'post_logout_landing_url' => is_string($user['post_logout_landing_url'] ?? null)
                            ...
                            : '',
                        'about_me' => is_string($user['about_me'] ?? null) ? (string) $user['about_me'] : '',
                        'linkedin_url' => is_string($user['linkedin_url'] ?? null) ? (string) $user['linkedin_url'] : '',
                        'x_url' => is_string($user['x_url'] ?? null) ? (string) $user['x_url'] : '',
                        'youtube_url' => is_string($user['youtube_url'] ?? null) ? (string) $user['youtube_url'] : '',
                        'profile_contact_email' => is_string($user['profile_contact_email'] ?? null) ? (string) $user['profile_contact_email'] : '',
                        'profile_contact_phone' => is_string($user['profile_contact_phone'] ?? null) ? (string) $user['profile_contact_phone'] : '',
