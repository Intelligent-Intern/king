...
- broader cross-backend quota/throttling failure normalization and upload-recovery classification around the now-real core/cloud surface
...
- `./infra/scripts/test-extension.sh`: `487/487` passing
...
- `extension/tests`: `487` PHPT files
