...
- remaining upload-recovery classification and recovery-path normalization around the now-real core/cloud surface
...
- `./infra/scripts/test-extension.sh`: `489/489` passing
...
- `extension/tests`: `489` PHPT files
