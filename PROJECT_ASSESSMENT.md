...
- orchestrator compensation semantics and observability depth
...
- `./infra/scripts/test-extension.sh`: `492/492` passing
...
- `extension/tests`: `492` PHPT files
