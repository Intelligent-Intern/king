...
now exhausted. No new executable leaves are pulled into `ISSUES.md` until the
user explicitly asks for PR/publish flow or another batch.
...
- `./infra/scripts/test-extension.sh`: `522/522` passing
...
- `extension/tests`: `522` PHPT files
