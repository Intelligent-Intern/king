...
- `./scripts/test-extension.sh`: `367/367` passing
...
- `extension/tests`: `367` PHPT files
- public stub parity: `127` functions, `43` classes, `48` declared public methods
