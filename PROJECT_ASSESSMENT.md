...
- release-grade persistence-migration and config-state compatibility gates
...
- `./scripts/test-extension.sh`: `349/349` passing
...
- `extension/tests`: `349` PHPT files
...
- Persisted-state compatibility and old/new configuration-state behavior are still not yet under an explicit matrix gate.
