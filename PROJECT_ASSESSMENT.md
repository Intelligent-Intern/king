...
- deeper CDN/cache/edge behavior under restart, large-object memory pressure, and observability across the real object-store backends
...
- `./infra/scripts/test-extension.sh`: `538/538` passing
...
- `extension/tests`: `538` PHPT files
