...
- `./scripts/test-extension.sh`: `362/362` passing
...
- `extension/tests`: `362` PHPT files
...
- The next missing proof is concrete and repo-local: real listener coverage for server HTTP/2 and HTTP/3, plus more explicit WebSocket violation/abort handling.
