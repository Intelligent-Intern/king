...
`extension/src/media/`. The media module owns its PHP arginfo, function-table
entries, and RTP object binding, and is included directly by the extension
bootstrap through the public media header surface.
