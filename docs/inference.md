...
needs the remaining attention, residual, FFN, and logits device ops plus bounded
...
`gpu_decoder_graph_linear_execution`, `gpu_prompt_decoder_loop`,
...
the CUDA quantized matvec kernel and releases the temporary output buffer.
