...
- [ ] Validate recovery after incomplete writes for the real object-store `cloud_s3` backend.
...
- object-store cloud backend failure slices beyond the now-real `cloud_s3` payload path: migration and recovery
