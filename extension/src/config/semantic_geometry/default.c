...
void kg_config_semantic_geometry_defaults_load(void)
{
    ...
    king_semantic_geometry_config.calculation_precision = pestrdup("float64", 1);
    king_semantic_geometry_config.convex_hull_algorithm = pestrdup("qhull", 1);
    king_semantic_geometry_config.point_in_polytope_algorithm = pestrdup("ray_casting", 1);
    king_semantic_geometry_config.hausdorff_distance_algorithm = pestrdup("exact", 1);
