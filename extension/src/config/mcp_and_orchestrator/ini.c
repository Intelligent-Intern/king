...
PHP_INI_BEGIN()
    ...
    STD_PHP_INI_ENTRY("king.mcp_allowed_peer_hosts", "", PHP_INI_SYSTEM, OnUpdateString, mcp_allowed_peer_hosts, kg_mcp_orchestrator_config_t, king_mcp_orchestrator_config)
    STD_PHP_INI_ENTRY("king.mcp_transfer_state_path", "", PHP_INI_SYSTEM, OnUpdateString, mcp_transfer_state_path, kg_mcp_orchestrator_config_t, king_mcp_orchestrator_config)
