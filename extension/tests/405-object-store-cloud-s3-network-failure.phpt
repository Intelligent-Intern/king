--TEST--
King object-store cloud_s3 surfaces endpoint connection failures through runtime status and write failures
--SKIPIF--
<?php
...
$root = sys_get_temp_dir() . '/king_object_store_s3_network_' . getmypid();
if (!is_dir($root)) {
