#ifndef KING_CLIENT_HTTP3_H
#define KING_CLIENT_HTTP3_H
...
/**
 * @brief Sends an HTTP/3 request over QUIC.
 *
 ...
 * @param options_array Optional transport and timeout options, including an
 * optional `King\Session` resource for connection reuse.
