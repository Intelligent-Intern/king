#ifndef KING_CLIENT_HTTP2_H
#define KING_CLIENT_HTTP2_H

#include <php.h>

/**
 * @file extension/include/client/http2.h
 * @brief HTTP/2 client entry point.
 */
