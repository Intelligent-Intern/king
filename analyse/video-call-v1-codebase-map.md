...
- `demo/call-app/call-diagnostics/` is the packaged diagnostics Call App. It contains `call-app.manifest.json`, CRDT schema, MCP/health descriptors, and static `public/` assets.
