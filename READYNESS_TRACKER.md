...
- Recent QUIC bootstrap closure: the build path now rehydrates pinned LSQUIC, BoringSSL, ls-qpack, and ls-hpack source archives from `infra/scripts/lsquic-bootstrap.lock` without branch-based fallbacks or unlocked Cargo retries.
