...
require_literal(build_profile, "boringssl_static_link_libs()", "build-profile pinned BoringSSL static library selector")
require_literal(build_profile, "\"-Wl,--exclude-libs,ALL\"", "build-profile Linux BoringSSL static library hiding")
require_literal(build_profile, "\"${lsquic_runtime_prefix}/boringssl/lib/libssl.a\"", "build-profile Linux/macOS BoringSSL ssl archive")
require_literal(build_profile, "\"${lsquic_runtime_prefix}/boringssl/lib/libcrypto.a\"", "build-profile Linux/macOS BoringSSL crypto archive")
require_literal(build_profile, "\"${lsquic_runtime_prefix}/boringssl/lib/ssl.lib\"", "build-profile Windows BoringSSL ssl import library")
require_literal(build_profile, "\"${lsquic_runtime_prefix}/boringssl/lib/crypto.lib\"", "build-profile Windows BoringSSL crypto import library")
require_literal(build_profile, "KING_BORINGSSL_LIBS=\"$(boringssl_static_link_libs)\"", "build-profile uses host-selected BoringSSL static libraries")
